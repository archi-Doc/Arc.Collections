...
namespace Arc.Collections
{
    ...
    /// <br/><see cref="UnorderedMultiSet{T}"/> uses a hash table structure to store objects.
    /// </summary>
    /// <typeparam name="T">The type of elements in the set.</typeparam>
    public class UnorderedMultiSet<T> : ICollection<T>, IReadOnlyCollection<T>, ICollection
    {
        /// <summary>
        ...
        private UnorderedMultiMap<T, int> map;

        #region Main

        /// <summary>
        /// Gets the number of nodes actually contained in the <see cref="UnorderedMultiSet{T}"/>.
        /// </summary>
        ...
        public UnorderedMultiMap<T, int>.KeyCollection.Enumerator GetEnumerator() => this.map.Keys.GetEnumerator();
