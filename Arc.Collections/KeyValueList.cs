...
{
    /// <summary>
    /// Represents a list of key value pairs that can be accessed by index.
    /// </summary>
    ...
    public class KeyValueList<TKey, TValue>
    {
        ...
        {
            public Pair(KeyValueList<TKey, TValue> list, int index)
            {
                this.List = list;
                this.Index = index;
            }
            ...
            public TKey Key
            {
                get => this.List.GetKey(this.Index);
                set => this.List.SetKey(this.Index, value);
            }

            internal readonly KeyValueList<TKey, TValue> List;
