...
namespace Arc.Collection.HotMethod
{
    ...
    public sealed class StandardMethod2<TKey, TValue> : IHotMethod2<TKey, TValue>
    {
        ...
        public (int cmp, OrderedMultiMap2<TKey, TValue>.Node? leaf) SearchFirstNode(OrderedMultiMap2<TKey, TValue>.Node? target, TKey key)
        {
            var x = target;
            var p = target;
            int cmp = 0;
        ...
        public (int cmp, OrderedMultiMap2<TKey, TValue>.Node? leaf) SearchLastNode(OrderedMultiMap2<TKey, TValue>.Node? target, TKey key)
        {
            var x = target;
            var p = target;
            int cmp = 0;
